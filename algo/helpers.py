# 0 = Western Governors University 4001 South 700 East, Salt Lake City, UT 84107
...
# 6 Salt Lake City Streets and Sanitation
...
distance_matrix = [
    ...
    #2
    [3.8, 7.1, 0.0, 9.2, 4.4, 2.8, 8.6, 9.2, 4.4, 2.8, 8.6, 9.2, 4.4, 2.8, 8.6, 5.8, 5.7, 4.1, 3.6, 4.3, 3.3, 5.0, 6.1, 9.7, 6.1, 2.8, 7.4],
    #3
